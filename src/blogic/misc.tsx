...
export class Fields {
  static values(): FieldNT[] {
    return [
      {nameTech: FIELD_NAME_TECH_ASAU9.TEXT_FIELD, nameVisual: 'Text Field'} as FieldNT,
      {nameTech: FIELD_NAME_TECH_ASAU9.DATE, nameVisual: 'Date'} as FieldNT,
      {nameTech: FIELD_NAME_TECH_ASAU9.DATETIME_LOCAL, nameVisual: 'Date & time local'} as FieldNT,
      {nameTech: FIELD_NAME_TECH_ASAU9.DATE_MONTH, nameVisual: 'Month'} as FieldNT,
      {nameTech: FIELD_NAME_TECH_ASAU9.DATE_WEEK, nameVisual: 'Week'} as FieldNT,
      {nameTech: FIELD_NAME_TECH_ASAU9.DATE_TIME, nameVisual: 'Time'} as FieldNT,
      {nameTech: FIELD_NAME_TECH_ASAU9.EMAIL, nameVisual: 'Email'} as FieldNT,
      {nameTech: FIELD_NAME_TECH_ASAU9.PASSWORD, nameVisual: 'Password'} as FieldNT,
      {nameTech: FIELD_NAME_TECH_ASAU9.TEL, nameVisual: 'Tel'} as FieldNT,
      {nameTech: FIELD_NAME_TECH_ASAU9.TEXT_AREA, nameVisual: 'Text area'} as FieldNT,
      {nameTech: FIELD_NAME_TECH_ASAU9.COLOR, nameVisual: 'Color'} as FieldNT,
      {nameTech: FIELD_NAME_TECH_ASAU9.NUMBER, nameVisual: 'Number'} as FieldNT,
      {nameTech: FIELD_NAME_TECH_ASAU9.RANGE, nameVisual: 'Range'} as FieldNT,
      {nameTech: FIELD_NAME_TECH_ASAU9.CHECKBOX, nameVisual: 'Checkbox'} as FieldNT,
      ...
      {nameTech: FIELD_NAME_TECH_ASAU9.HIDDEN, nameVisual: 'Hidden'} as FieldNT,
      {nameTech: FIELD_NAME_TECH_ASAU9.RESET, nameVisual: 'Reset'} as FieldNT,
      {nameTech: FIELD_NAME_TECH_ASAU9.SEARCH, nameVisual: 'Search'} as FieldNT,
      {nameTech: FIELD_NAME_TECH_ASAU9.SUBMIT, nameVisual: 'Submit'} as FieldNT,
      {nameTech: FIELD_NAME_TECH_ASAU9.BUTTON, nameVisual: 'Button'} as FieldNT,
    ]
  }
